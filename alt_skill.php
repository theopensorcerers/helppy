...
<!-- new code for request form -->
                            
							<a href="#menu-toggle" data-toggle="dropdown" class="btn btn-default" id="request_skill_btn"  ><h4>Request a skill</h4></a>
                            
                              
                <ul class="dropdown-menu form-group" name="reqform1">
                  
                 Ask <?php echo $user['username'] ?> for help with <?php echo $skill['skill_name'] ?> 
                ...
                <textarea autofocus name="reqform" class="form-control" rows="10"></textarea>
                
                <a href="#menu-toggle" class="btn btn-primary btn-block" id="send_btn">Send</a>
                </div></li></ul>
<!-- end of new code --> 
						</div>
