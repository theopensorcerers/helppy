			...
			<div class="container">
				...
				<div id="info" class="row">
				  <div class="col-xs-12 col-md-3">
				  	<a href="/about_us.php" class="title">
				  		<h2>About Us</h2>
				  	</a>
